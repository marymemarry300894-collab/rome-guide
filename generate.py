...
days = [
    {
        ...
        "places": [
            ...
            {"img": b["trevi"], "name": "Фонтан Треви", "time": "12:30 – 13:30",
             "desc": "Просмотр фонтана бесплатен — он стоит в открытой площади. Платные только экскурсии/опыты рядом (Google часто показывает «от ~2 €» именно по ним) и соседние аттракционы вроде Vicus Caprarius. Бросьте монетку на возвращение в Рим — лучше рано утром или вечером, меньше толпы.",
  ...
  <div class="tickets">
    ...
    <table>
      ...
      <tbody>
        ...
        <tr><td>Фонтан Треви</td><td class="free">бесплатно (просмотр)</td><td>—</td><td>платные экскурсии от ~2 €</td></tr>
